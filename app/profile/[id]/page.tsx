...
export default function PublicProfilePage() {
  ...
  async function startPrivateCall() {
    if (!viewerId || !profile || viewerId === profile.id || callLoading) return;
        ...
        <div className="overflow-hidden rounded-3xl border border-red-900/30 bg-gray-950 shadow-2xl shadow-red-950/20">
          ...
          <div className="relative -mt-48 border-t border-red-900/20 bg-gradient-to-b from-black/40 via-gray-950/90 to-black p-5 pt-16 backdrop-blur-[1px] sm:-mt-56 sm:p-8 sm:pt-20">
            ...
            <div className="mt-6 grid grid-cols-2 gap-4 sm:max-w-md">
              <div className="rounded-2xl border border-red-900/25 bg-black/40 p-4 shadow-lg shadow-black/20">
